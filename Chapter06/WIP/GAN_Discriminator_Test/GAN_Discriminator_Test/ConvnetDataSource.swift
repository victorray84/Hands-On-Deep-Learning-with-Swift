...
extension ConvnetDataSource{
    ...
    private func generateRandomWeights() -> Data?{
        ...
        */
        //let magnitude = Float32(sqrt(6.0 / (Double(self.inputFeatureChannels + self.outputFeatureChannels))))
//        let magnitude = Float32(abs(sqrt(3.0 / (Double(0.5 * self.inputFeatureChannels + 0.5 * self.outputFeatureChannels)))))
